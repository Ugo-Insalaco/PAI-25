...
INSERT INTO `cont_cadran` VALUES (2,6,'#062C6B','/assets/images/actifstechniques/exImageFond.png','/assets/images/actifstechniques/logo.png',7,8),(3,65,'#03b0b4','/assets/images/confortenergieenvironnement/exImageFond.jpg','/assets/images/confortenergieenvironnement/logo.png',66,71),(4,67,'#cc2871','/assets/images/bienetre/exImageFond.jpg','/assets/images/bienetre/logo.png',68,72),(5,69,'#0caaeb','/assets/images/espaces/exImageFond.jpg','/assets/images/espaces/logo.png',70,73);
...
INSERT INTO `cont_fra` VALUES (1,'Salut ça va ?!'),(2,'Ouais ça va et toi gros ?!'),(3,'c\'est moi la data'),(4,'numero1'),(5,' Bonjour je suis le sous_texte'),(6,' Actifs Techniques'),(7,'/assets/images/actifstechniques/cerclesBandeau.png'),(8,'Exemple de problématique'),(9,'Supervision des équipements CVC'),(10,'Texte offre supervision équipements CVC'),(11,'Production de froid'),(12,'Texte prod de froid'),(13,'Pb prod de froid'),(14,'Arg prod de froid'),(15,'Production de chaud'),(16,'Texte prod de chaud'),(17,'Pb prod de chaud'),(18,'Arg prod de chaud'),(19,'Choissisez votre solution :'),(20,'Retour état brûleur uniquement si le brûleur a une sortie TOR d\'état disponible'),(21,'Nombre de chaudières :'),(22,'Souhaitez-vous personnaliser votre solution en ajoutant d\'autres IoT ?'),(23,'Selectionnez les autres IoT à ajouter :'),(24,'Souhaitez-vous utiliser un réseau public ou privé ?'),(25,'Quelle application souhaitez-vous utiliser ?'),(26,'Type d\'hébergement et accès logiciel :'),(27,'Type de dashboard :'),(28,'Précisez l\'outil souhaité :'),(29,'Précisez le besoin :'),(30,'Fonctionnalités souhaitées :'),(31,'Souhaitez-vous internaliser ou externaliser l\'installation des IoT ?'),(32,'Souhaitez-vous internaliser ou externaliser la création des dashboards ?'),(33,'Durée de vie souhaitée de la solution (en année) :'),(34,'Ajouter un commentaire :'),(35,'T° départ/retour'),(36,'T° départ/retour + retour état brûleur'),(37,'number'),(38,'Oui'),(39,'Non'),(40,'Réseau public LoRaWAN Orange'),(41,'Réseau privé LoRaWAN avec GW WATTSENSE'),(42,'IoThink'),(43,'SaaS (Cloud)'),(44,'On-Premise (Serveur interne client)'),(45,'Autre'),(46,'Public (au catalogue avec plan 2d)'),(47,'Spécifique'),(48,'Alertes (dépassement seuil, évènement...)'),(49,'Reporting'),(50,'Aucune (accès dashboard uniquement)'),(51,'text'),(52,'text'),(53,'[ là il faudrait la liste de tous les iot disponibles donc à voir ]'),(54,'Internaliser'),(55,'Externaliser (VF RHÔNE IIT)'),(56,'Internaliser'),(57,'Externaliser (VF RHÔNE IIT)'),(58,'number'),(59,'text'),(60,'Capteurs et connectivité'),(61,'Application et fonctionnalités'),(62,'Installation physique des IoT et création du dashboard'),(63,'Récapitulatif et validation'),(64,'https://www.orange-business.com/fr/reseau-iot'),(65,'Environnement'),(66,'/assets/images/confortenergieenvironnement/cerclesBandeau.png'),(67,'Santé et Bien-être'),(68,'/assets/images/bienetre/cerclesBandeau.png'),(69,'Esapces'),(70,'/assets/images/espaces/cerclesBandeau.png'),(71,'Problématique Environnement'),(72,'Problématique Santé et bien-être'),(73,'Problématique Espaces'),(74,'La flexibilité et l\'agilité des espaces collaboratifs contribuent à la performance sociétale et économique de l\'entreprise. '),(75,'Le coût élevé du mètre carré dans les immobiliers tertiares incite les entreprises à revoir l\'utilisation de l\'espace pour en optimiser chaque m². '),(76,'La qualité de vie au travail est un levier de performance de l\'entreprise.'),(77,'Des conditions de travail négligées entraînent démotivation, maladie, absentéisme et forte proportion de turnover. '),(78,'L\'amélioration de la qualité de vie au travail conduit à motiver le personnel, à le fidéliser et à l\'impliquer dans la réussite de l\'entreprise.'),(79,'Toutes les activités économiques ont un double impact sur l\'environnement.'),(80,'Les activités économiques puisent dans les ressources naturelles (matières premières, énergie, eau…) dont elles ont besoin pour fonctionner et elles rejettent des déchets (eaux usées, fumées, déchets industriels...) en condribuant ainsi à la dégration de l\'environnement.'),(81,'Les budgets liés aux prestations de maintenance multi-technique sont revus à la baisse.'),(82,'Il faut faire mieux avec moins.'),(83,'Le monitoring des équipements est un moyen technologique à bas coût permettant la détection de dérives de fonctionnement et d\'anticipation de pannes.'),(84,'Gestion des espaces'),(85,'Optimisation des espaces'),(86,'Qualité de vie au travail'),(87,'Hygiène'),(88,'Maitrise des énergies '),(89,'Maitrise des déchets '),(90,'Supervision des équipements CVC'),(91,'Légionnelle ECS'),(92,'Rondes d\'exploitation'),(93,'Sécurité '),(94,'Le coût élevé du mètre carré dans les immobiliers tertiares incite les entreprises à revoir l\'utilisation de l\'espace pour en optimiser chaque m². '),(95,'Les bâtiments représentent 43 % de la consommations énergétique française.'),(96,'Réduire l\'impact environnemental des bâtiments en devenu un impératif pour l\'ensemble des acteurs de l\'immobilier.'),(97,'La mesure continue de l\'impact énergétique rélle de son propre bâtiment est la 1ère étape permettant l\'optimisation de ses consomamtions énergétiques.'),(98,'Améliorer la gestion ainsi que la collecte des déchets est un levier de perofmance.'),(99,'Le taux de remplissage de vos bennes.'),(100,'Faire communiquer les équipements à moindre coût.'),(101,'Les techologies filaires traditionnelles.'),(102,'Un mauvais entretien des réseaux ECS peut être la cause de la prolifération de la bactérie mortelle de la légionnelle.');
