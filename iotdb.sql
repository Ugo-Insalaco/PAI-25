...
CREATE TABLE `question_nombre_ref` (
  ...
  KEY `id` (`id`),
  KEY `product` (`product`),
  KEY `FK_question_nombre_ref2_reponse` (`sous_solution`),
  CONSTRAINT `FK__products` FOREIGN KEY (`product`) REFERENCES `products` (`id`),
  CONSTRAINT `FK__question` FOREIGN KEY (`id`) REFERENCES `question` (`id`),
  CONSTRAINT `FK_question_nombre_ref2_reponse` FOREIGN KEY (`sous_solution`) REFERENCES `reponse` (`id`)
...
INSERT INTO `question_nombre_ref` VALUES (20,39,1,85);
...
-- Dump completed on 2021-05-31 17:39:19
